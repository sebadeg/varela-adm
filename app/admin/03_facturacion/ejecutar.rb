...
ActiveAdmin.register_page "Ejecutar" do
  ...
  page_action :prueba, method: :post do   
    ...
    #   f.write("\r\n" )
      ...
      Inscripcion.where("anio=2020 AND ((NOT reinscripcion) OR (reinscripcion AND inscripto)) AND NOT proximo_grado_id IS NULL").order(:proximo_grado_id,:convenio_id).each do |x|
